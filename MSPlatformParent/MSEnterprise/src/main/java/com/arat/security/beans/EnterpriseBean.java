...
public class EnterpriseBean implements Serializable {
     ...
     */
	  ...
	  public void setEnterpriseId(long iEnterpriseId) { this.enterpriseId =
	  iEnterpriseId; }
     ...
     */
	  ...
	  public void setParentId(long iParentId) { this.parentId = iParentId; }
     ...
     */
	  ...
	  public long getEnterpriseId() { return this.enterpriseId; }
